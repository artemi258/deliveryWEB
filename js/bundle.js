...
var slider = function slider() {
  ...
  function slidesActive() {
    ...
    sliders.forEach(function (item) {
      ...
      item.classList.remove('slider__active', 'wow', 'animate__animated', 'animate__fadeIn'); //     item.querySelector('.slider__img').style.cssText = `
      //   width: 72px;
      //   height: 72px;
      //   `
      //      item.querySelector('.slider__name').style.cssText = `
    ...
    sliders[1].classList.add('slider__active', 'wow', 'animate__animated', 'animate__fadeIn'); //      sliders[1].querySelector('.slider__img').style.cssText = `
    //      width: 114px;
    //      height: 114px;
    //  `
...
/* harmony default export */ const modules_form = (form_forms);
...
/* harmony default export */ const modules_scrolling = (scrolling);
;// CONCATENATED MODULE: ./src/js/modules/gamburger.js
...
/* harmony default export */ const modules_gamburger = (gamburger);
...
/* harmony default export */ const modules_up = (up);
// EXTERNAL MODULE: ./node_modules/wowjs/dist/wow.js
var wow = __webpack_require__(5541);
